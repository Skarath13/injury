...
const TRUSTED_CRAWLER_PATTERN = /\b(?:Googlebot|Googlebot-Image|Bingbot|OAI-SearchBot|ChatGPT-User|GPTBot|Google-Extended|ClaudeBot|Claude-SearchBot|Claude-User|PerplexityBot)\b/i;
      ...
      <section class="panel" aria-labelledby="geo-title">
        ...
        <div class="content">
          ...
          <div class="actions">
            ...
            <a class="secondary" href="mailto:support@californiasettlementcalculator.com?subject=California%20access%20help">Contact support</a>
          </div>
