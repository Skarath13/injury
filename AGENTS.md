...
This file contains important context for Codex when working on this project.
...
**Note for Codex**: This project has been through significant troubleshooting, particularly around CSS loading and PWA implementation. The current configuration is stable and working. Be cautious about making structural changes that might reintroduce CSS loading issues.
