...
import { Calendar, Car, AlertTriangle, Zap, MapPin } from 'lucide-react';
import InfoIcon from '@/components/InfoIcon';
import { CALIFORNIA_COUNTIES } from '@/lib/californiaCounties';
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          {errors.accidentDetails?.county && (
            <p className="mt-1 text-sm text-red-600">{errors.accidentDetails.county.message}</p>
          )}
        </div>
